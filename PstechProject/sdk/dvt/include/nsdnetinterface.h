...
//////////////////////////////////////////////////
//事件通知回调
typedef int (WINAPI *ModuleServerMsgCallback)(NSD_MODULE_MSG_HEAD_S * lpMsgHead,const char * lpMsg,unsigned int nMsgLen,const void *& pResultContent,unsigned int & nResultLen);
...
#if !defined(_WIN32)
int WINAPI NSDNET_LoginLocal(const char * lpSunPath,unsigned char nID,unsigned long nRsvd,void * lpLogonContext,HANDLE * lpLogin);
...
NSDAPI int WINAPI NSDNET_SendModuleMsg(HANDLE hLogin,NSD_MODULE_MSG_HEAD_S msgHead,const char * lpMsg,unsigned int nMsgLen,const void *& pResultContent,unsigned int & nResultLen);
NSDAPI int WINAPI NSDNET_SetModuleServerMsgCallback(ModuleServerMsgCallback lpCallback);
